...
**Landing Page**
Displays latest games of [14 UEFA teams with highest club coefficients ](https://www.uefa.com/memberassociations/uefarankings/club/#/yr/2021) in the carousel. Data fetched by _static generation_ for performance.  
<img src="./images/sc1.png" width="1200">

**Competition Page**
Sorts latest games by top 4 UEFA leagues: Premier League, La Liga, Bundesliga, Serie A. Data fetched by _static generation_ for performance.
<img src="./images/sc2.png" width="1200">

**Search Page**
Displays latest games of the team searched by the user. Data fetched by _server-side rendering_ for most updated data.
